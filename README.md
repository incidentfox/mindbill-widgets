...
California anesthesia service lines collect actual elapsed minutes separately from the service quantity. The existing form supports documented physician-alone cases with modifier AA, preserves the diagnosis selector, and requires a new estimate when the timing or circumstances change. See [California anesthesia](docs/california-anesthesia.md).
