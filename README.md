...
### Connected treatment authorization

The framework-neutral `createRfaWorkflowClient` powers native Angular RFA flows
and can connect the existing React draft/destination controls. See
