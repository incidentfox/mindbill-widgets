...
export function BillRejectionNotice({ rejection, title = "Why it was rejected", appearance, className, style }: BillRejectionNoticeProps): ReactElement {
  return (
    <section className={classes("mb-surface mb-rejection-notice", className)} style={mindBillAppearanceStyle(appearance, style)} role="alert" aria-label="Bill rejection reason">
      <style>{lifecycleSurfaceStyles}</style>
      <header className="mb-surface-heading"><div><strong>{title}</strong><span>Correct this issue before resubmitting.</span></div></header>
      <div className="mb-rejection-reason">
        {rejection.code ? <span className="mb-rejection-code">{rejection.code}</span> : null}
...
.mb-rejection-notice{border-left:5px solid var(--mb-danger);background:color-mix(in srgb,var(--mb-danger) 6%,var(--mb-surface));padding-left:18px}.mb-rejection-notice .mb-surface-heading{margin-bottom:12px}.mb-rejection-notice .mb-surface-heading strong{color:var(--mb-danger)}.mb-rejection-reason{display:flex;align-items:flex-start;gap:10px}.mb-rejection-reason p{margin:1px 0 0;font-size:15px;line-height:1.5}.mb-rejection-code{flex:0 0 auto;border:1px solid color-mix(in srgb,var(--mb-danger) 35%,var(--mb-border));border-radius:999px;background:var(--mb-surface);color:var(--mb-danger);font-size:12px;font-weight:800;padding:3px 8px}.mb-rejection-meta{margin:12px 0 0;color:var(--mb-muted);font-size:12px}
