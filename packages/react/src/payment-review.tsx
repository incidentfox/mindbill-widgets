...
/** Ledger entry IDs are unique within a bill, not necessarily across bills. */
export const paymentReviewRowKey = (item: Pick<PaymentReviewItem, "billId" | "id">): string => JSON.stringify([item.billId, item.id]);
